...
<div id="modalEditar" class="modal-overlay">
    <div class="modal-box">
        ...
        <form method="POST" class="eval-form" id="formEditar">
...
document.addEventListener('DOMContentLoaded', function(){
    ...
    function colorPorProfesor(profesorId, profesorNombre = '') {
        const mapaColores = {
            // Ejemplos:
            // 3: '#dc2626',
            // 5: '#2563eb',
    ...
    return {
        ...
        eventDidMount:function(info){
            ...
            const color = colorPorProfesor(profesorId, profesorNombre);
            info.el.style.color = '#ffffff88'; // blanco
